                    ...
                    <div className="lg:col-span-1 flex flex-col gap-6">
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <div className="bg-slate-50 border text-center border-dashed border-slate-200 rounded-xl p-6 flex flex-col justify-center items-center opacity-70 cursor-not-allowed">
                                    <i className="fas fa-hammer text-2xl mb-2 text-slate-400"></i>
                                    <h3 className="font-bold text-sm text-slate-500">신규 게임 준비 중</h3>
                                    <p className="text-xs text-slate-400 mt-1">곧 업데이트됩니다</p>
                                </div>
                            </div>
                        </div>
                    </div>
