...
// ==================== 게임 메뉴 ====================
export function getGameMenu(currentPage) {
    const menuItems = [
...
// ==================== 심플 게임 사이드바 ====================
export function getSimpleGameSidebar(currentPage) {
    const games = [
...
function createMenu(menuItems, currentPage, activeColor) {
    let menuHtml = '<nav class="bg-white border-b border-gray-200 shadow-sm"><div class="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6"><div class="flex space-x-8 overflow-x-auto">';
    for (const item of menuItems) {
...
export function getLifestyleMenu(currentPage) {
...
export function getFinanceMenu(currentPage) {
    return createMenu([
...
export function getEntertainmentMenu(currentPage) {
    return createMenu([
...
export function getEducationMenu(currentPage) {
    return createMenu([
...
export function getShoppingMenu(currentPage) {
    return createMenu([
...
// ==================== 공통 헤더 ====================
export function getCommonHeader(sectionName = '') {
...
// ==================== 공통 인증 스크립트 ====================
export function getCommonAuthScript() {
    return `
    <script>
...
// ==================== 가입 유도 팝업 ====================
export function getAuthPopupScript() {
    return `
    <script>
...
// ==================== 공통 푸터 ====================
export function getCommonFooter() {
    return `
...
// ==================== 관리자 네비게이션 ====================
export function getAdminNavigation(currentPage) {
    const menuItems = [
