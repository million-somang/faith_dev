...
export const translations: Record<SupportedLang, Record<string, string>> = {
    ko: {
        ...
        '맞춤 뉴스': '맞춤 뉴스',
        '실시간 뉴스': '실시간 뉴스',
        '뉴스를 불러오는 중입니다...': '뉴스를 불러오는 중입니다...',
        '세상의 모든 정보를 한곳에서': '세상의 모든 정보를 한곳에서',
        '실시간 뉴스 · 금융 시세 · 미니게임 · 생활 도구까지, FaithPortal 하나면 충분해요': '실시간 뉴스 · 금융 시세 · 미니게임 · 생활 도구까지, FaithPortal 하나면 충분해요',
        '무엇을 찾으시나요?': '무엇을 찾으시나요?',
        '검색': '검색',
        '엔터': '엔터',
        '교육': '교육',
        '게임 선택': '게임 선택',
        '틈날 때 가볍게, 무료로 즐기는 미니게임': '틈날 때 가볍게, 무료로 즐기는 미니게임',
        '테트리스 · 스도쿠 · 2048 · 지뢰찾기 — 설치 없이 브라우저에서 바로 플레이하세요': '테트리스 · 스도쿠 · 2048 · 지뢰찾기 — 설치 없이 브라우저에서 바로 플레이하세요',
        '종목': '종목',
        '환율': '환율',
        '은행': '은행',
        '보험': '보험',
    ...
    en: {
        ...
        '증시': 'Markets',
        '환율 USD': 'USD Rate',
        '인기종목 더보기': 'More Stocks',
        '더보기': 'More',
        '맞춤 뉴스': 'Custom News',
        '실시간 뉴스': 'Live News',
        '뉴스를 불러오는 중입니다...': 'Loading news...',
        '세상의 모든 정보를 한곳에서': 'All Information in One Place',
        '실시간 뉴스 · 금융 시세 · 미니게임 · 생활 도구까지, FaithPortal 하나면 충분해요': 'Real-time news, financial rates, mini games & utility tools — all in FaithPortal',
        '무엇을 찾으시나요?': 'Search news, games, tools...',
        '검색': 'Search',
        '엔터': 'Entertainment',
        '교육': 'Education',
        '게임 선택': 'Select Game',
        '틈날 때 가볍게, 무료로 즐기는 미니게임': 'Casual & Free Mini Games for Your Free Time',
        '베라 팝 · 클래식 프리셀 · 스도쿠 · 2048 · 지뢰찾기 — 설치 없이 브라우저에서 바로 플레이하세요': 'Vera Pop · FreeCell · Sudoku · 2048 · Minesweeper — Play right in browser without installation',
        '종목': 'Stocks',
        '환율': 'Exchange',
        '은행': 'Banking',
        '보험': 'Insurance',
