...
app.use('*', cors({
    ...
    allowHeaders: ['Content-Type', 'Authorization', 'X-API-KEY', 'x-api-key', 'X-Requested-With'],
...
const miniApps = [
    ...
    'base64-converter', 'svg-converter', 'news', 'comboy', 'sfc', 'saju', 'novel', 'severance-calc', 'interest-calc', 'vera-pop', 'customs-calc'
];
