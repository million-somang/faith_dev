...
const CATALOG: CatalogItem[] = [
    ...
    { label: '베라장기', desc: '9×10 정통 한국 장기 & 묘수풀이', href: '/game/janggi', icon: 'fa-chess-knight', color: 'text-cyan-600', bg: 'bg-cyan-50', keywords: ['장기', '베라장기', 'janggi', '한국장기', '묘수풀이', '민속장기', '외통수'] },
    { label: '베라오목', desc: '15×15 브라우저 AI 오목', href: '/game/omok', icon: 'fa-circle-dot', color: 'text-amber-600', bg: 'bg-amber-50', keywords: ['오목', '베라오목', 'omok', 'gomoku', '바둑', '5목'] },
