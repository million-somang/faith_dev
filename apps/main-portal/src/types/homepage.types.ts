...
export const ALL_QUICK_MENU_ITEMS: QuickMenuItem[] = [
    ...
    { id: 'finance-util', label: '금융Util', icon: 'fa-chart-pie', href: '/finance/util', color: 'text-amber-600', bg: 'bg-amber-50' },
...
export const ALL_MOBILE_TAB_ITEMS: MobileTabItem[] = [
    ...
    { id: 'finance-util', label: '금융Util', icon: 'fas fa-chart-pie', path: '/finance/util', color: '#d97706' },
