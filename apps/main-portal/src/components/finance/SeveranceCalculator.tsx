        ...
        <div className="space-y-8 max-w-5xl mx-auto">
            ...
            <section className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm space-y-6 text-slate-700">
                <h3 className="text-xl font-black text-slate-900 flex items-center gap-2">
                    <i className="fas fa-book-open text-teal-600"></i> 퇴직금 및 실업급여 수급 자격 완벽 가이드
                </h3>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs leading-relaxed">
                    <div className="space-y-2 bg-slate-50 p-4.5 rounded-2xl border border-slate-200/70">
                        <h4 className="font-extrabold text-slate-900 text-sm">1. 실업급여(구직급여) 수급 필수 요건</h4>
                        <p>
                            퇴직 전 18개월간 고용보험 가입일수가 <strong>180일 이상</strong>이어야 하며, <strong>비자발적 퇴사(권고사직, 계약만료, 폐업 등)</strong>여야 합니다. 자진퇴사는 원칙적으로 불가하나 정당한 이직 사유(임금체불, 건강악화 등)가 인정되는 경우 예외적으로 가능합니다.
                        </p>
                    </div>

                    <div className="space-y-2 bg-slate-50 p-4.5 rounded-2xl border border-slate-200/70">
                        <h4 className="font-extrabold text-slate-900 text-sm">2. 퇴직금 중간정산이 가능한 사유는?</h4>
                        <p>
                            원칙적으로 금지되나 <strong>무주택자의 본인 명의 주택 구입 및 전세금(보증금) 부담</strong>, 본인 또는 부양가족의 6개월 이상 요양, 파산선고 또는 개인회생 절차 개시 시 법적으로 중간정산이 허용됩니다.
                        </p>
                    </div>
                </div>
                ...
                <div className="border-t border-slate-100 pt-6">
                    ...
                    <dl className="space-y-3 text-xs">
                        <div>
                            <dt className="font-bold text-slate-900">Q. 실업급여 수급 중 아르바이트를 해도 되나요?</dt>
                            <dd className="text-slate-600 mt-0.5">
                                A. 근로시간이나 소득이 발생하는 모든 활동은 고용센터에 신고해야 하며, 일정 기준 이상의 소득이 발생하면 해당 일자의 구직급여가 감액되거나 지급 유예될 수 있습니다.
                            </dd>
                        </div>
                    </dl>
                </div>
