...
export default function SeveranceCalc({ onShowToast }: SeveranceCalcProps) {
  ...
  const handleCalculate = () => {
    if (totalDays <= 0) {
      onShowToast('입사일과 퇴사일을 올바르게 설정해주세요.');
      return;
    }
        ...
        <>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200/80 rounded-2xl p-4 flex items-start gap-3 shadow-xs">
            ...
            <div className="text-xs text-slate-700 leading-relaxed">
              ...
              <p className="text-slate-600">
                입사일/퇴사일과 급여를 입력 후 <strong>[퇴직금 계산하기]</strong> 버튼을 누르면 1일 평균임금과 2026년 개정 세법 기준 <strong>세후 실수령 퇴직금</strong>이 즉시 산출됩니다.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-4.5 sm:p-5 border border-slate-200/80 shadow-xs space-y-4">
            ...
            <button
              ...
              className="w-full py-3.5 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white text-sm font-black rounded-xl shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2 cursor-pointer active:scale-98"
            >
