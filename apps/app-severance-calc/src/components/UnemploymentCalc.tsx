          ...
          <div className="bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200/80 rounded-2xl p-4 flex items-start gap-3 shadow-xs">
            ...
            <div className="text-xs text-slate-700 leading-relaxed">
              ...
              <p className="text-slate-600">
                수급 자격과 3개월 평균 급여를 입력 후 <strong>[실업급여 계산하기]</strong> 버튼을 누르면 2026년 법정 <strong>상한액(66,000원)</strong> 및 <strong>하한액(64,192원)</strong>을 자동 비교 판정하여 예상 수급액을 산출합니다.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-4.5 sm:p-5 border border-slate-200/80 shadow-xs space-y-4">
            ...
            <div>
              <label className="block text-[11px] font-bold text-slate-600 mb-1.5">
                퇴직 당시 만 나이 <span className="text-[10px] text-slate-400 font-normal">(수급일수 기준)</span>
              </label>
            ...
            <div>
              ...
              <div className="grid grid-cols-3 sm:grid-cols-5 gap-1.5">
                {[
                  ...
                  { key: '1to3', label: '1년~3년' },
                  { key: '3to5', label: '3년~5년' },
                  { key: '5to10', label: '5년~10년' },
              ...
              <p className="text-[10px] text-slate-400 mt-1.5">
                * 현재 조건 매핑 소정 급여일수: <strong className="text-emerald-700 font-black">{benefitDays}일</strong>
              </p>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  step={100000}
                  className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-300 rounded-xl text-xs font-black text-slate-900 focus:bg-white focus:border-emerald-600 outline-none transition-colors pr-10"
                />
                ...
                {[2000000, 2500000, 3000000, 3500000, 4000000, 5000000].map((val) => (
                  <button
                    ...
                    className={`text-[10px] font-bold px-2.5 py-1 rounded-lg border transition-all cursor-pointer whitespace-nowrap ${
                      monthlyWage === val ? 'bg-emerald-600 text-white border-emerald-600 shadow-xs' : 'bg-slate-50 text-slate-600 border-slate-200 hover:bg-slate-100'
                    }`}
                  >
            ...
            <div>
              <label className="block text-[11px] font-bold text-slate-600 mb-1">
                1일 소정 근로시간 <span className="text-[10px] text-slate-400 font-normal">(하한액 계산 기준)</span>
              </label>
              <select
                value={workingHours}
            ...
            <button
              ...
              className="w-full py-3.5 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white text-sm font-black rounded-xl shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2 cursor-pointer active:scale-98"
            >
              <i className="fas fa-shield-alt text-amber-300 text-sm"></i>
              <span>실업급여 계산하기</span>
            </button>
          </div>
        </>
        ...
        <div key={calcKey} className="bg-gradient-to-br from-slate-900 via-teal-950 to-slate-900 text-white rounded-3xl p-5 sm:p-6 shadow-xl border border-teal-800/40 space-y-5 animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-2.5 pt-2 border-t border-white/10">
            ...
            <button
              type="button"
              onClick={copyResult}
              className="flex-1 py-3 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white text-xs font-black rounded-xl shadow-md transition-all flex items-center justify-center gap-2 cursor-pointer active:scale-98"
            >
              <i className="fas fa-copy"></i>
              <span>결과 복사하기</span>
            </button>
